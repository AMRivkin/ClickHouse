...
| <a name="enable-rdkafka"></a>[`ENABLE_RDKAFKA`](https://github.com/clickhouse/clickhouse/blob/master/cmake/find/rdkafka.cmake#L2) | `ENABLE_LIBRARIES` | Enable kafka |  |
...
| <a name="use-internal-rdkafka-library"></a>[`USE_INTERNAL_RDKAFKA_LIBRARY`](https://github.com/clickhouse/clickhouse/blob/master/cmake/find/rdkafka.cmake#L17) | `NOT_UNBUNDLED` | Set to FALSE to use system librdkafka instead of the bundled |  |
